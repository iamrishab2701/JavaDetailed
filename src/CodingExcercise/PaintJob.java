...
*
* he objective of this coding exercise is to create a simple program that helps Bob the Painter calculate how many buckets of paint he needs before he starts a job.
    * */
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBucket) {
        if (width <= 0 || height <= 0 || areaPerBucket <= 0 || extraBucket < 0) {
            ...
            double bucketsRequired = (getBucketCount(width, height, areaPerBucket) - extraBucket);
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket) {
        if (width < 0 || height < 0 || areaPerBucket < 0) {
            ...
            double bucketsRequired = getBucketCount(wallArea, areaPerBucket);
            return (int) (Math.ceil(bucketsRequired));
        }
    }
